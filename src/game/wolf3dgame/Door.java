...
public class Door extends Entity {
    ...
    public void update(Input inputStatus) {
        ...
        int doorX = (int)getRenderable().getTransformation().getPosition().getX();
        int doorY = (int)getRenderable().getTransformation().getPosition().getZ();
    ...
    public boolean isRotated() {
        return getRenderable().getTransformation().getRotation().getY() == 90;
    }
}
