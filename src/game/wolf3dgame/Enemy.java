...
public class Enemy extends Entity {
    ...
    public void update(Input inputStatus) {
        ...
        getRenderable().getTransformation().getRotation().setY(cameraAngle + 90);
        getRenderable().getTransformation().getPosition().setY(0.5f);
        ...
        if(state == STATE_IDLE && isPlayerVisible())
            ...
            getRenderable().getTransformation().getRotation().setX(85);
            getRenderable().getTransformation().getPosition().setY(0.02f);
        }
    }
