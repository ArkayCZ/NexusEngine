...
public abstract class MappedClass {
    ...
    public void addInteger(String name, int value) { mIntegers.put(name, value); }
    public int getInteger(String name) { return mIntegers.get(name); }

    public void addFloat(String name, float value) { mFloats.put(name, value); }
    public float getFloat(String name) { return mFloats.get(name); }

    public void addVector2(String name, Vector2 value) { mVector2s.put(name, value); }
    public Vector2 getVector2(String name) { return mVector2s.get(name); }

    public void addVector3(String name, Vector3 value) { mVector3s.put(name, value); }
    public Vector3 getVector3(String name) { return mVector3s.get(name); }

    public void addQuaternion(String name, Quaternion value) { mQuaternions.put(name, value); }
    public Quaternion getQuaternion(String name) { return mQuaternions.get(name); }

    public void addMaterial(String name, Material value) { mMaterials.put(name, value); }
    public Material getMaterial(String name) { return mMaterials.get(name); }

    public void addMatrix(String name, Matrix value) { mMatrices.put(name, value); }
    public Matrix getMatrix(String name) { return mMatrices.get(name); }

    public void addTexture(String name, Texture value) { mTextures.put(name, value); }
    public Texture getTexture(String name) { return mTextures.get(name); }
